...
use app\modules\api\v1\models\Establecimiento;
 ...
 */
class EstablecimientoController extends ActiveController
{
    public $modelClass = 'app\modules\api\v1\models\Establecimiento';
...
//        unset($actions['update']);
    ...
    /*
     * Realiza una busqueda filtrado la data según los datos paramnetrizados; acepta
     * terminos de filtrado, paginacion y ordenación
     */
    public function actionListado(){
        try{
            $modelBusqueda = new Establecimiento();
            
            $modelSearchRequest = \Yii::$app->request->get('modelSearch');
            ...
            $parametros = \Yii::$app->request->get();
    ...
    public function actionEditar(){
        try{
            $modelRequest = \Yii::$app->request->post('model');
            $modelRequest =  json_decode($modelRequest, true);
            $model = Establecimiento::findOne($modelRequest['id']);
            if(!$model)
